...
{// G0 says wether the restriction strategy should be used (G0=false since graph G isn't the root graph G0) or not. In the latter case, fill 
	// lists : **restr_list, **pairs, and * npairs. Otherwise, use these lists to apply the restrictions
