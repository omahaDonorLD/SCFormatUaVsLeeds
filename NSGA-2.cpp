...
string param_path = "param.txt" ; 						// chemin d'accès au fichier paramètre par défaut



/* Can be read in a param file */
bool TESTMODE = 0 ;			// 0 Si on affiche les informations, 1 sinon ( car en test ).
